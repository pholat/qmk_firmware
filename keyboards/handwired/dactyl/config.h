...
// you need to change this if you use different expander pins than standard
// i.e. please see readme.md for help with non standard pins #define MATRIX_EXPANDER_COL_PINS {6, 5, 4, 3, 2, 1}
...
/* Set if you require changes on expander pin order and work from here in matrix.c */
#define NON_STANDARD_ROW
